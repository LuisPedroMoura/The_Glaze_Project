...
def old_photo(im):
    ...
    im2 = Image.open("textures/texture_old_film.jpg")
...
def pencil_draw(im):
    ...
    # soft pencil texture
    im2 = Image.open("textures/texture_pencil1.jpg")
    if width < height:
        im2 = rotate(im2)
    # hard pencil texture
    im3 = Image.open("textures/texture_pencil2.jpg")
    if width < height:
        im3 = rotate(im3)
...
def color_draw(im):
    ...
    im2 = Image.open("textures/texture_pencil4.jpg")
    if width < height:
        im2 = rotate(im2)
    ...
    im4 = Image.open("textures/texture_pencil1.jpg")
    if width < height:
        im4 = rotate(im4)
...
def circles_sepia(im):
    """Option 26 - Creates mosaic and aply dotted grid"""
